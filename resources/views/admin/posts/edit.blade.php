                    ...
                    <div class="form-group">
                        ...
                        @foreach ($tags as $tag)
                            <div class="form-check form-check-inline">
                                @if (old("tags"))
                                    <input type="checkbox" class="form-check-input" name="tags[]" id="{{$tag->slug}}" value="{{$tag->id}}" {{in_array( $tag->id, old("tags", []) ) ? 'checked' : ''}}>
                                @else
                                    <input type="checkbox" class="form-check-input" name="tags[]" id="{{$tag->slug}}" value="{{$tag->id}}" {{$post->tags->contains($tag) ? 'checked' : ''}}>
                                @endif
